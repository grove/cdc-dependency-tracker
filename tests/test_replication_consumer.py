...
class TestAutoCreation:
    ...
    def test_ensure_slot_exists_when_slot_exists(self, mock_connect, replication_config, mock_routing_engine):
    ...
    @patch('cdc_dependency_tracker.replication_consumer.psycopg2.connect')
    def test_ensure_slot_created_when_missing(self, mock_connect, replication_config, mock_routing_engine):
    ...
    @patch('cdc_dependency_tracker.replication_consumer.psycopg2.connect')
    def test_ensure_publication_exists_when_publication_exists(self, mock_connect, replication_config, mock_routing_engine):
    ...
    @patch('cdc_dependency_tracker.replication_consumer.psycopg2.connect')
    def test_ensure_publication_created_with_tables(self, mock_connect, replication_config, mock_routing_engine):
    ...
    @patch('cdc_dependency_tracker.replication_consumer.psycopg2.connect')
    def test_ensure_publication_created_all_tables(self, mock_connect, replication_config, mock_routing_engine):
